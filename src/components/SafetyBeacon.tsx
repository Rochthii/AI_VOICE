...
export const SafetyBeacon: React.FC<SafetyBeaconProps> = ({
  ...
  return (
    <>
      <header className="w-full flex flex-col justify-between p-4 pb-3 bg-gradient-to-b from-[#FAF7F2] to-[#F4F0E6] border-b border-[#E2D9C8] select-none shadow-[0_2px_8px_rgba(0,0,0,0.02)]">
